...
Hits (wave 4):
- sample-brain — home directory in git (.cache .cargo .npm .next). brain.json 1.83 MB is the signal; caches are not.
- sample-dev-pilot — backend/node_modules committed
- Little-Pro-V10- — .next + node_modules + 0-byte skin pages
- sample-refinery — node_modules committed
